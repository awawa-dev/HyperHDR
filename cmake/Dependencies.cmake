...
macro(DeployUnix TARGET)
	if (EXISTS ${TARGET_FILE})
		...
		if ( CEC_SUPPORT )
			...
			set(resolved_file2 "${resolved_file}.2")
			if(EXISTS ${resolved_file2})
				message(STATUS "Adding CEC2: ${resolved_file2}")
				get_filename_component(resolved_file2 ${resolved_file2} ABSOLUTE)
				gp_append_unique(PREREQUISITE_LIBS ${resolved_file2})
				message(STATUS "Added CEC2: ${resolved_file2}")
			endif()
			get_filename_component(file_canonical ${resolved_file} REALPATH)
			gp_append_unique(PREREQUISITE_LIBS ${file_canonical})
