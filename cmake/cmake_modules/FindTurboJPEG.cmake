...
if (NOT WIN32)
  ...
  endforeach()
  find_path(TurboJPEG_INCLUDE_DIR NAMES turbojpeg.h HINTS ${ToolkitPaths} PATHS "[HKLM/SOFTWARE/WOW6432Node/${lib_turbo_registry};Install_Dir]/include" "c:/libjpeg-turbo/include" "c:/libjpeg-turbo64/include" )
  find_file(TurboJPEG_INSTALL_LIB NAMES turbojpeg.dll HINTS ${ToolkitPaths} PATHS "[HKLM/SOFTWARE/WOW6432Node/${lib_turbo_registry};Install_Dir]/bin" "c:/libjpeg-turbo/bin" "c:/libjpeg-turbo64/bin" NO_DEFAULT_PATH)
...
if(NOT TurboJPEG_LIBRARY)
  if (NOT WIN32)
    ...
    find_library(TurboJPEG_LIBRARY_RELEASE HINTS ${ToolkitPaths} PATHS "[HKLM/SOFTWARE/WOW6432Node/${lib_turbo_registry};Install_Dir]/lib/cmake" "c:/libjpeg-turbo/lib" "c:/libjpeg-turbo64/lib" NAMES ${TurboJPEG_names} NAMES_PER_DIR)
    find_library(TurboJPEG_LIBRARY_DEBUG HINTS ${ToolkitPaths} PATHS "[HKLM/SOFTWARE/WOW6432Node/${lib_turbo_registry};Install_Dir]/lib/cmake" "c:/libjpeg-turbo/lib" "c:/libjpeg-turbo64/lib" NAMES ${TurboJPEG_names_debug} NAMES_PER_DIR)
  endif()
