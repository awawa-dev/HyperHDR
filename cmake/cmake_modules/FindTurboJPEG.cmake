...
if(NOT TurboJPEG_LIBRARY)
  if (NOT WIN32)
    ...
    find_library(TurboJPEG_LIBRARY_RELEASE PATHS "c:/libjpeg-turbo/lib" "c:/libjpeg-turbo64/lib" NAMES ${TurboJPEG_names} NAMES_PER_DIR)
    find_library(TurboJPEG_LIBRARY_DEBUG PATHS "c:/libjpeg-turbo/lib" "c:/libjpeg-turbo64/lib" NAMES ${TurboJPEG_names_debug} NAMES_PER_DIR)
  endif()
