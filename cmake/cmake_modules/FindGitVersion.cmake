...
SET ( HYPERHDR_BUILD_ID "${VERSION_ID} (${BUILD_ID})" )
SET ( HYPERHDR_GIT_REMOTE "${GIT_REMOTE_PATH}" )
message ( STATUS "Current Version: ${HYPERHDR_VERSION}" )
message ( STATUS " - Build: ${HYPERHDR_BUILD_ID}" )
