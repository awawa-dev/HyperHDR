...
SET ( CPACK_PACKAGE_FILE_NAME "HyperHDR-${HYPERHDR_VERSION}-${DEBIAN_NAME_TAG}-${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}")
...
if ( ENABLE_CEC )
	SET ( CPACK_DEBIAN_PACKAGE_RECOMMENDS "libp8-platform-dev" )
endif()
