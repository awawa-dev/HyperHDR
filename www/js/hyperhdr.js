...
async function requestLutCalibration(mode, debug, detailed_calibration)
{
	sendToHyperhdr("lut-calibration", mode, `"debug":${debug}, "detailed_calibration":${detailed_calibration}`);
}
