...
void HyperionDaemon::handleSettingsUpdate(settings::type settingsType, const QJsonDocument& config)
{
	...
	else if (settingsType == settings::V4L2)
	{
		...
		{		
			...
			connect(this, &HyperionDaemon::videoModeHdr, _mfGrabber, &MFWrapper::setHdrToneMappingEnabled);			
			connect(this, &HyperionDaemon::settingsChanged, _mfGrabber, &MFWrapper::handleSettingsUpdate);
			connect(_mfGrabber, &MFWrapper::HdrChanged, this, &HyperionDaemon::videoModeHdr);			
		}
		...
		connect(_v4l2Grabber, &V4L2Wrapper::HdrChanged, this, &HyperionDaemon::videoModeHdr);
#elif !defined(ENABLE_QTC)	
