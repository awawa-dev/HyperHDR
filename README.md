...
[Download the latest test build](https://github.com/awawa-dev/HyperHDR/releases/tag/latest-build)

Fresh daily builds shipped at π time (3:14 UTC) whenever we have something new.
