...
function startWizardPhilipsHue(e) {
  ...
  $('#wizp1_body').html('<h4 style="font-weight:bold;text-transform:uppercase;">' + $.i18n(hue_title) + '</h4><p>' + $.i18n(hue_intro1) + '<br/><p style="color:red"><b>Please make sure that you have disconnected lamps from all kind of home-automation systems. Otherwise the instance will stop working as soon as other system updates the lamp&rsquo;s state!</b><br/><br/>In such case in logs there will be message about:<br/>&quot;parameter ... is not modifiable. Device is set to off&quot;<br/></p></p>');
  $('#wizp1_footer').html('<button type="button" class="btn btn-primary" id="btn_wiz_cont"><i class="fa fa-fw fa-check"></i>' + $.i18n('general_btn_continue') + '</button><button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-fw fa-close"></i>' + $.i18n('general_btn_cancel') + '</button>');
