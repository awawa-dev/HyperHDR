#include <led-drivers/net/DriverNetFadeCandy.h>
...
DriverNetFadeCandy::DriverNetFadeCandy(const QJsonObject& deviceConfig)
...
bool DriverNetFadeCandy::initNetwork()
{
	bool isInitOK = false;
...
bool DriverNetFadeCandy::isConnected() const
{
...
bool DriverNetFadeCandy::tryConnect()
{
	if (_client != nullptr)
	{
...
qint64 DriverNetFadeCandy::transferData()
{
...
qint64 DriverNetFadeCandy::sendSysEx(uint8_t systemId, uint8_t commandId, const QByteArray& msg)
{
	if (isConnected())
	{
...
void DriverNetFadeCandy::sendFadeCandyConfiguration()
{
