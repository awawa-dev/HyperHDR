...
#include <led-drivers/net/DriverNetAtmoOrb.h>
...
DriverNetAtmoOrb::DriverNetAtmoOrb(const QJsonObject& deviceConfig)
...
void DriverNetAtmoOrb::setColor(int orbId, const ColorRgb& color, int commandType)
{
	QByteArray bytes;
