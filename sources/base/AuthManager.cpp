...
const QString AuthManager::loadPipewire()
{
...
void AuthManager::savePipewire(const QString& wToken)
{
...
bool AuthManager::resetHyperhdrUser()
{
...
QString AuthManager::getID() const
{
	return _uuid;
}
...
bool AuthManager::isLocalAuthRequired() const
{
	return _localAuthRequired;
}

bool AuthManager::isLocalAdminAuthRequired() const
{
	return _localAdminAuthRequired;
}

bool AuthManager::isUserAuthBlocked() const
{
	return (_userAuthAttempts.length() >= 10);
}

bool AuthManager::isTokenAuthBlocked() const
{
