...
public:
	...
	///
	void registerInput(int priority, hyperhdr::Components component, const QString& origin = "System", const QString& owner = "", unsigned smooth_cfg = SMOOTHING_MODE_DEFAULT);
...
signals:
	...
	///
	void visibleComponentChanged(hyperhdr::Components comp);
