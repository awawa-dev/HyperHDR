...
public:
	void renderRgbwFrame(const std::vector<linalg::aliases::float3>& infiniteColors, const bool smooth, const float& whiteMixerThreshold, const float& whiteLedIntensity, const linalg::aliases::float3& whitePointRgb, std::vector<uint8_t>& output, size_t writeIndex, bool rgbOrder);
