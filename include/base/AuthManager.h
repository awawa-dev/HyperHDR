...
///
/// @brief Manage the authorization of user and tokens. This class is created once as part of the HyperHdrDaemon
...
private:
	...
	/// constructor is private, can be called from HyperHdrDaemon
